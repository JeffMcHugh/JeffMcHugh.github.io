	...
	var callback= function(data){
		...
		if(iteration === 4) {    
		    ...
		    if(topCtyTable[0][1][3]>1000000000) {
          		var valIndicator="Value in Billions of Dollars";			 
				...
				up5=commaSeparateNumber((Number(topCtyTable["12"][1][9]/1000000000).toFixed(2)));
	  			...
	  			var valIndicator="Value in Millions of Dollars";
				...
				up1growth="-";
	  			...
	  			var valIndicator="Value in Thousands of Dollars";
		...
		$("th.second").html($("th.second").html().replace('Value in Dollars', valIndicator));
